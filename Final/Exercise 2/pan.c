...
short src_ln1 [] = {
	  0,  25,  26,  28,  29,  30,  31,  31, 
	 27,  34,  27,  34,  24,  36,  24,  36, 
	  0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "solution.pml", 1, 15 },
...
short src_ln0 [] = {
	  0,   8,   9,  11,  12,  13,  14,  14, 
	 10,  17,  10,  17,   7,  19,   7,  19, 
	  0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "solution.pml", 1, 15 },
...
{	int j = 0, h = now._nr_pr;
	...
	case 1:	/* Q */
		...
		((P1 *)pptr(h))->you = 0;
#ifdef VAR_RANGES
		logval("Q:me", ((P1 *)pptr(h))->me);
		logval("Q:you", ((P1 *)pptr(h))->you);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* P */
		...
		((P0 *)pptr(h))->you = 1;
#ifdef VAR_RANGES
		logval("P:me", ((P0 *)pptr(h))->me);
		logval("P:you", ((P0 *)pptr(h))->you);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
