...
#define _nstates1	16	/* Q */
#define minseq1	15
#define maxseq1	29
#define _endstate1	15

#define _nstates0	16	/* P */
#define minseq0	0
#define maxseq0	14
...
#define Air1	(sizeof(P1) - Offsetof(P1, you) - 1*sizeof(uchar))
...
#define Air0	(sizeof(P0) - Offsetof(P0, you) - 1*sizeof(uchar))
