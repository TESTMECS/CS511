...
#define _nstates2	33	/* :init: */
#define minseq2	64
#define maxseq2	95
#define _endstate2	32

#define _nstates1	15	/* Machine */
#define minseq1	50
#define maxseq1	63
#define _endstate1	14

#define _nstates0	51	/* Car */
#define minseq0	0
#define maxseq0	49
...
#define HAS_TRACK	0
/* hidden variable: */	uchar machine_working[3];
