...
short src_ln2 [] = {
	  0,  69,  69,  70,  71,  72,  73,  69, 
	 74,  74,  74,  76,  74,  77,  77,  78, 
	 77,  79,  79,  79,  80,  79,  80,  80, 
	 81,  80,  82,  82,  82,  83,  82,  76, 
	 84,   0, };
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "car_wash.pml", 1, 32 },
...
short src_ln1 [] = {
	  0,  14,  14,  13,  12,  59,  60,  58, 
	 19,  18,  63,  54,  65,  54,  65,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "car_wash.pml", 1, 14 },
	{ "-", 15, 16 }
...
short src_ln0 [] = {
	  0,  14,  14,  13,  12,  25,  25,  25, 
	 19,  18,  14,  14,  13,  12,  14,  14, 
	 13,  12,  31,  32,  33,  30,  19,  18, 
	 19,  18,  14,  14,  13,  12,  14,  14, 
	 13,  12,  41,  42,  43,  40,  19,  18, 
	 19,  18,  14,  14,  13,  12,  48,  48, 
	 19,  18,  50,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "car_wash.pml", 1, 50 },
...
iniglobals(int calling_pid)
{
	{	int l_in;
		...
		{
			machine_working[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 3; l_in++)
		{
			now.permToProcess[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 3; l_in++)
		{
			now.doneProcessing[l_in] = 0;
		}
	}
		now.station0 = 1;
		now.station1 = 1;
	...
	{	int l_in;
		for (l_in = 0; l_in < 3; l_in++)
		{
			logval("permToProcess[l_in]", now.permToProcess[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 3; l_in++)
		{
			logval("doneProcessing[l_in]", now.doneProcessing[l_in]);
		}
	}
	...
	{	int l_in;
		for (l_in = 0; l_in < 3; l_in++)
		{
			logval("cars_in_station[l_in]", now.cars_in_station[l_in]);
		}
	}
#endif
}
...
{	/* int i; */
	...
	{	int l_in;
		for (l_in = 0; l_in < 3; l_in++)
		{
			printf("	byte   permToProcess[%d]:	%d\n", l_in, now.permToProcess[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 3; l_in++)
		{
			printf("	byte   doneProcessing[%d]:	%d\n", l_in, now.doneProcessing[l_in]);
		}
	}
	...
	{	int l_in;
		for (l_in = 0; l_in < 3; l_in++)
		{
			printf("	byte   cars_in_station[%d]:	%d\n", l_in, now.cars_in_station[l_in]);
		}
	}
}
void
...
{	/* int i; */
	...
	printf("	byte   i:	%d\n", ((P2 *)pptr(pid))->i);
		break;
	case 1:
		printf("local vars proc %d (Machine):\n", pid);
	printf("	int    i:	%d\n", ((P1 *)pptr(pid))->i);
		break;
	case 0:
		/* none */
